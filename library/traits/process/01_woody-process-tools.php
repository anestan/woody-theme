...
trait WoodyThemeTrait_WoodyProcessTools
{
    /**
     *
     * Nom : getMinMax
     ...
     * @param    data_key - Acf field name
     * @return   return - Code HTML
     *
     */
    //TODO: cette fonction n'est utilisée nulle part ?
    ...
    public function getInstagramMetadata($attachment_id = null)
    {
        if (!empty($attachment_id) && is_int($attachment_id)) {
